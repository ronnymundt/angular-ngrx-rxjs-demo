...
export const userListInitialState: IUserListState = userListAdapter.getInitialState({
  ids: [],
  entities: {},
  page: 0,
  per_page: 0,
...
export const userListReducer = createReducer(
  ...
  on(
    UserListActions.addMany,
    (state, { users }) => userListAdapter.addMany(users, state),
  ),
  on(
